                ...
                <main>
                    <div class="row contacts">
                        <div class="col invoice-to">
                            ...
                            <h2 class="to">{{ $billing_info->name }}</h2>
                            <div class="address"> <i class="fa fa-home" aria-hidden="true"></i> {{ $billing_info->address }}</div>
                            <div class="phoneNumber"> <i class="fa fa-mobile" aria-hidden="true"></i> {{ $billing_info->phone_number }}</div>
                            <div class="email"><a href="{{ $billing_info->email }}"> <i class="fa fa-envelope" aria-hidden="true"></i> {{ $billing_info->email }}</a></div>
                        </div>
