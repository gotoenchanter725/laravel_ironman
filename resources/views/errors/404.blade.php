  ...
  <body>
    ...
    <div class="ht-100v bg-sl-primary d-flex align-items-center justify-content-center">
      <div class="wd-lg-70p wd-xl-50p tx-center pd-x-40">
        ...
        <p class="tx-16 mg-b-30 tx-white-5">The page you are looking for might have been removed, had its name changed, or unavailable. Maybe you could try a search:</p>
        ...
        <div class="tx-center mg-t-20">... or back to <a href="{{ route('home') }}">home</a></div>
      </div>
    </div><!-- ht-100v -->
