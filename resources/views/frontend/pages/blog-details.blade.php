                            ...
                            <div class="row">
                                    ...
                                    <div class="sewl-form-inputs no-padding-left">
                                        <div class="row">
                                            <div class="col-sm-6 col-12">
                                                <input id="name" name="commenter_name" value="{{ old('commenter_name') }}" tabindex="2" placeholder="Name" type="text">
                                            </div>
                                            <div class="col-sm-6 col-12">
                                                <input id="email" name="commenter_email" value="{{ old('commenter_email') }}" tabindex="3" placeholder="Email" type="email">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-submit">
                                        ...
                                        <input type="hidden" name="user_id" value="unknown">
